                ...
                foreach($row->result() as $key => $data) {?>
                  <tr>
                    ...
                    <td class="text-center">
                        <a href="<?=site_url('kategori/ubah/'.$data->id_kategori)?>" class="btn btn-xs btn-primary">
                        <i class="fa fa-pencil-alt"></i> Ubah</a>

                        <a href="<?=site_url('kategori/hapus/'.$data->id_kategori)?>" id="btn-hapus" class="btn btn-xs btn-danger">
