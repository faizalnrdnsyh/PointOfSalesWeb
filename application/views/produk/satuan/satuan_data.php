          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              <ul class="nav nav-pills ml-auto">
                <li class="nav-item">
                  <a href="<?=site_url('satuan/tambah')?>" class="btn btn-success">
                ...
                foreach($row->result() as $key => $data) {?>
                  <tr>
                    ...
                    <td class="text-center">
                        <a href="<?=site_url('satuan/ubah/'.$data->id_satuan)?>" class="btn btn-xs btn-primary">
                        <i class="fa fa-pencil-alt"></i> Ubah</a>

                        <a href="<?=site_url('satuan/hapus/'.$data->id_satuan)?>" id="btn-hapus" class="btn btn-xs btn-danger">
