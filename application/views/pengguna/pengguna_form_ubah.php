            ...
            <div class="row">
				<div class="col-md-6 offset-md-3">
					<div class="form-group row">
						...
						<input type="text" name="namalengkap" class="form-control <?=form_error('namalengkap') ? 'is-invalid' : null?>" id="namalengkap" value="<?=$this->input->post('namalengkap') ?? $row->nama?>" maxlength="50" autofocus>
					...
					<div class="form-group row">
						...
						<div class="col-sm-7">
						<input type="text" name="namapengguna" class="form-control <?=form_error('namapengguna') ? 'is-invalid' : null?>" id="namapengguna" value="<?=$this->input->post('namapengguna') ?? $row->nama_pengguna?>" maxlength="50">
					...
					<div class="form-group row">
						...
						<div class="col-sm-7">
						<input type="password" name="katasandi" class="form-control <?=form_error('katasandi') ? 'is-invalid' : null?>" id="katasandi" value="<?=$this->input->post('katasandi')?>" maxlength="50">
					...
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<textarea id="alamat" type="text" name="alamat" class="form-control" maxlength="200"><?=$this->input->post('alamat') ?? $row->alamat?></textarea>
						</div>
					</div>
					<div class="form-group row">
