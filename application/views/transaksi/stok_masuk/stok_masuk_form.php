		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<?php if($this->uri->segment(4) == 'restok') { ?>
							<h1>Restok</h1>
						<?php } else {?>
							<h1>Stok Masuk</h1>
						<?php } ?>
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li href="" class="breadcrumb-item">Stok Masuk</li>
							<?php if($this->uri->segment(4) == 'restok') { ?>
				...
				<div class="card">
					...
					<div class="card-header">
						...
						<div class="card-tools">
							<ul class="nav nav-pills ml-auto">
								<li class="nav-item">
									<a href="<?=site_url('stok/masuk')?>" class="btn btn-warning">
						...
						<div class="row">
							<div class="col-md-6 offset-md-3">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" value="" name="keterangan" class="form-control" placeholder="kulakan / tambahan / dll" maxlength="100" required>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<select name="pemasok" class="form-control custom-select">
												...
												<?php foreach($pemasok as $key => $data) { 
					...
					<div class="card-footer">
						<div class="text-center">
							<button class="btn btn-success" type="submit" name="tambah_masuk">
