          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              <ul class="nav nav-pills ml-auto">
                <li class="nav-item">
                  <a href="<?=site_url('stok/keluar/tambah')?>" class="btn btn-success">
              ...
              <tbody>
                      ...
                      <tr>
                        ...
                        <td width="160px">
                          ...
                          <a href="<?=site_url('stok/keluar/hapus/'.$data->id_stok.'/'.$data->id_barang)?>" id="btn-hapus" class="btn btn-xs btn-danger">
